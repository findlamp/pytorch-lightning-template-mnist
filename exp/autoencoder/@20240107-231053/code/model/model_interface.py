...
class MInterface(pl.LightningModule, SaverMixin):
    ...
    def render_img(self, img, recon_img, H, W):

        self.save_image_grid(f"it{self.global_step}.png", [
            {'type': 'rgb', 'img': img.view(H, W, 3), 'kwargs': {'data_format': 'HWC'}},
            {'type': 'rgb', 'img': recon_img.view(H, W, 3), 'kwargs': {'data_format': 'HWC'}}
        ])
        return
